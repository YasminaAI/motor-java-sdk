...
import com.yasminaai.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncYasminaaiApiClientBuilder {
     ...
     * Sets token
     */
    public AsyncYasminaaiApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncYasminaaiApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncYasminaaiApiClientBuilder url(String url) {
     ...
     */
    public AsyncYasminaaiApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncYasminaaiApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncYasminaaiApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncYasminaaiApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncYasminaaiApiClientBuilder addHeader(String name, String value) {
    ...
    public AsyncYasminaaiApiClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncYasminaaiApiClient(buildClientOptions());
    }
}
