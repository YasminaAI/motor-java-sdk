...
public class RawQuotesClient {
    protected final ClientOptions clientOptions;

    public RawQuotesClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public YasminaaiApiHttpResponse<QuoteResponse> showQuote(int id) {
        return showQuote(id, GetQuoteRequestsIdRequest.builder().build());
    }

    public YasminaaiApiHttpResponse<QuoteResponse> showQuote(int id, RequestOptions requestOptions) {
        return showQuote(id, GetQuoteRequestsIdRequest.builder().build(), requestOptions);
    }

    public YasminaaiApiHttpResponse<QuoteResponse> showQuote(int id, GetQuoteRequestsIdRequest request) {
        return showQuote(id, request, null);
    }

    public YasminaaiApiHttpResponse<QuoteResponse> showQuote(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new YasminaaiApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, QuoteResponse.class), response);
            }
            try {
    ...
    public YasminaaiApiHttpResponse<DeleteQuoteRequestsIdResponse> deleteQuote(int id) {
        return deleteQuote(id, DeleteQuoteRequestsIdRequest.builder().build());
    }

    public YasminaaiApiHttpResponse<DeleteQuoteRequestsIdResponse> deleteQuote(int id, RequestOptions requestOptions) {
        return deleteQuote(id, DeleteQuoteRequestsIdRequest.builder().build(), requestOptions);
    }

    public YasminaaiApiHttpResponse<DeleteQuoteRequestsIdResponse> deleteQuote(
    ...
    public YasminaaiApiHttpResponse<DeleteQuoteRequestsIdResponse> deleteQuote(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new YasminaaiApiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DeleteQuoteRequestsIdResponse.class),
                        response);
            }
            try {
                if (response.code() == 404) {
     ...
     */
    public YasminaaiApiHttpResponse<QuoteResponse> requestQuotes(PostQuoteRequestsRequest request) {
     ...
     * The Quote IDs can be used later to issue a policy
     */
    public YasminaaiApiHttpResponse<QuoteResponse> requestQuotes(
