...
public class YasminaaiApiClientBuilder {
     ...
     * Sets token
     */
    public YasminaaiApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }

    public YasminaaiApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public YasminaaiApiClientBuilder url(String url) {
     ...
     */
    public YasminaaiApiClientBuilder timeout(int timeout) {
     ...
     */
    public YasminaaiApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public YasminaaiApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public YasminaaiApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public YasminaaiApiClientBuilder addHeader(String name, String value) {
    ...
    public YasminaaiApiClient build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new YasminaaiApiClient(buildClientOptions());
    }
}
